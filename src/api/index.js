...
const API = axios.create({ baseURL: `https://youtubeclone1-yur4.onrender.com/` });
...
export const deleteHistory = (userId) =>
  ...
  export const createPrivateChat = (privateChatData) => API.post('/private-chat', privateChatData);